...
NEW_COURSES = {
    ...
    "course-15": {
        "title": "Современная практика деятельности педагога-ассистента в сопровождении обучающихся с особыми образовательными потребностями",
        "subtitle": "Образовательная программа курса повышения квалификации педагогов",
        "reviews": [
            ("Елена Гордеева", "Курс помог точнее понять роль педагога-ассистента и выстроить ежедневное сопровождение ребёнка.", 5),
            ("Айжан Садыкова", "Практические алгоритмы взаимодействия с учителем и специалистами команды сразу применимы в школе.", 5),
            ("Марина Ким", "Особенно полезны примеры адаптации заданий без снижения самостоятельности обучающегося.", 5),
            ("Николай Петров", "Материал изложен понятно, границы ответственности педагога-ассистента обозначены чётко.", 4),
            ("Светлана Омарова", "Получила много идей для наблюдения, обратной связи и поддержки ребёнка на уроке.", 5),
            ("Динара Абдрахманова", "Раздел о коммуникации с семьёй помог выстроить более понятный порядок взаимодействия.", 5),
            ("Ольга Миронова", "Полезны рекомендации по постепенному сокращению помощи и развитию самостоятельности.", 5),
            ("Руслан Беков", "Курс практичный, хотелось бы ещё больше разборов сложных школьных ситуаций.", 4),
        ],
    },
    "course-16": {
        "title": "Ерекше білім беруді қажет ететін білім алушыларды сүйемелдеудегі педагог-ассистент қызметінің заманауи практикасы",
        "subtitle": "Педагогтердің біліктілігін арттыру курстарының білім беру бағдарламасы",
        "reviews": [
            ("Ақмарал Нұрбекқызы", "Курс педагог-ассистенттің міндеттері мен сүйемелдеу тәсілдерін жүйелі түсінуге көмектесті.", 5),
            ("Ержан Қасымов", "Мұғаліммен және қолдау мамандарымен командалық жұмысқа арналған ұсыныстар өте пайдалы.", 5),
            ("Гүлназ Әлиева", "Білім алушының дербестігін сақтай отырып тапсырмаларды бейімдеу мысалдары ұнады.", 5),
            ("Мадина Сәрсенова", "Педагог-ассистент жауапкершілігінің шекаралары нақты әрі түсінікті берілген.", 4),
            ("Нұрлан Төлеген", "Сабақтағы бақылау, кері байланыс және қолдау құралдарын жұмысымда қолданамын.", 5),
            ("Айнұр Жақыпова", "Отбасымен сенімді байланыс орнату бойынша берілген қадамдар тәжірибеде пайдалы болды.", 5),
            ("Самат Оразов", "Көмекті біртіндеп азайтып, баланың дербестігін дамыту тәсілдерін меңгердім.", 5),
            ("Ләззат Серікқызы", "Курс мазмұнды, күрделі жағдайларға арналған қосымша кейстер болса жақсы болар еді.", 4),
        ],
    },
}
